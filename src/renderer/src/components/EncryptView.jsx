...
export default function EncryptView({
  ...
  const handleDrop = (e) => {
    ...
    if (file && file.type === 'application/pdf' && file.path) {
      onDropFile(file.path, file.name, generatePassword())
    }
  }
      ...
      {hasError && (
        <div className="mt-4 flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl p-4 slide-up">
          ...
          <div>
            ...
            <p className="text-xs text-red-400 mt-1">Bitte prüfen Sie, ob qpdf installiert ist.</p>
          </div>
        </div>
      )}
          ...
          {isDone && (
            <div className="space-y-3">
              <div className="flex items-center gap-3 bg-emerald-50 border border-emerald-200 rounded-xl p-3.5">
                ...
                <button
                  onClick={() => window.api.showInFolder(state.outputPath)}
              ...
              <div className="bg-amber-50 rounded-2xl p-4 border border-amber-100">
                ...
                >
                  ...
                  <span>PDF-Mail in Outlook öffnen</span>
              ...
              <div className="bg-stone-50 rounded-2xl p-4 border border-stone-100">
                ...
                >
                  ...
                  <span>Passwort-Mail in Outlook öffnen</span>
                </button>
              </div>
